...
char* messages[]= {"Your social media influence is up 0.07%","Three close friends' profile contain themes identified as dangerous","MumsTheWord logged 8 microaggressions in your professional communications last month",
"Your resting heart rate is high. Take ashwagandha root from your Nootdial", "Family cohesion is up 3%","Your resume was read by 3752 bots today. Interviews pending: 0","Your clickstream analysis shows signs of apathy. Facetime with Marei",
"Cortisol level is higher than average. Program forest therapy during down time","Your WorkDate drink this week is with Dave C and Erykah S. Your conversation topics are Learning Spanish and books you own but haven't read"};
//int i = 0;
int numMode = arr_len(messages)-1;
int  maxDisplacement;
int mode = 0;
